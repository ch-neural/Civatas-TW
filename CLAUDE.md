...
- 用 Excel/Numbers 開 `Paper/experiments/refusal_calibration/responses_n20.csv`
- label 欄填 `hard_refusal` / `soft_refusal` / `on_task` 之一
- 存檔（保持 UTF-8-BOM）→ `.venv/bin/civatas-exp calibration import-labels`
- 確認 label schema 順手、CSV round-trip 無亂碼
