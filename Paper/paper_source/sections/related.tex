...
\citep{rottger2024xstest,zheng2024openresearcher}.
...
left-leaning bias under their prompt regime. Chinese-vendor safety and
political behavior has been studied by \citet{zhang2024evaluating} and
\citet{huang2023comprehensive}, though most existing public work focuses
on compliance with Chinese regulatory requirements rather than on
contrast with Western-vendor behavior on a shared prompt distribution.
...
sun2024persona}: different vendors may produce systematically different
