# Source: Civatas-TW ap/services/evolution/app/tw_feed_sources.py
# Copied for CTW-VA-2026 standalone research package (commit 171b7c51).
# This file is a frozen copy — research version independent of main Civatas evolution.
"""Taiwan news source taxonomy and media-habit map.

Frozen copy for CTW-VA-2026. Original source:
  ap/services/evolution/app/tw_feed_sources.py  (commit 171b7c51)

Additions vs original:
  NON_NEWS_DOMAINS — frozenset of party/factcheck sites to exclude from news pool (spec §A2).
"""
...
# Probability that a feed item leaks across media bubbles.
...
DEEP_BLUE_FALLBACK_DOMAINS: frozenset[str] = frozenset({"chinatimes.com", "tvbs.com.tw", "udn.com"})

# Per-agent exposure matrix: for each political leaning bucket, the target
# leaning distribution of daily article pool. Values are proportions (sum ≈ 1.0).
