...
TW_EVENT_CATALOG: list[dict[str, Any]] = [
    ...
    # ════════════ 交通 ════════════
    {
        "id": "traffic_commute_jam",
        "name": "通勤塞到瘋",
        "category": "traffic",
        "description": "上班路上被塞 1 個多小時",
        "probability": 0.10,
        "eligibility": {"age_min": 22, "age_max": 60,
                        "occupation_exclude": _RETIRED | _STUDENT | _HOMEMAKER},
        "effects": {"satisfaction_delta": -3, "anxiety_delta": 5},
        "cooldown_days": 30,
        "prompt_hint": "今天上班通勤塞超久，下車時已經滿身汗，整個人都煩躁。",
    },
    {
        "id": "traffic_scooter_stolen",
        "name": "機車被偷",
        "category": "traffic",
        "description": "停在路邊的機車早上不見了",
        "probability": 0.03,
        "eligibility": {"age_min": 22, "age_max": 65},
        "effects": {"satisfaction_delta": -8, "anxiety_delta": 10},
        "cooldown_days": 365,
        "prompt_hint": "早上出門發現機車不見了，報案處理一整天心情跌到谷底。",
    },
    {
        "id": "traffic_mrt_delay",
        "name": "捷運誤點",
        "category": "traffic",
        "description": "捷運/高鐵突發故障延誤",
        "probability": 0.06,
        "eligibility": {"age_min": 18, "age_max": 70},
        "effects": {"satisfaction_delta": -2, "anxiety_delta": 4},
        "cooldown_days": 30,
        "prompt_hint": "捷運誤點害你遲到，月台擠爆的體驗真是差。",
    },

    # ════════════ 詐騙 / 食安 ════════════
    {
        "id": "scam_line_investment",
        "name": "被詐騙",
        "category": "crime",
        "description": "LINE 上被假投資群組騙走錢或差點被騙",
        "probability": 0.04,
        "eligibility": {"age_min": 35, "age_max": 75},
        "effects": {"satisfaction_delta": -7, "anxiety_delta": 12},
        "cooldown_days": 300,
        "prompt_hint": "LINE 群組投資詐騙差點讓你損失慘重，氣到罵政府都抓不到詐騙集團。",
    },
    {
        "id": "food_safety_scandal",
        "name": "食安風暴",
        "category": "news",
        "description": "蛋荒／塑化劑／黑心商品等重大食安新聞",
        "probability": 0.07,
        "eligibility": {},
        "effects": {"satisfaction_delta": -4, "anxiety_delta": 8},
        "cooldown_days": 90,
        "prompt_hint": "最近食安爆雷（蛋荒／黑心油／塑化劑），家裡買東西都小心翼翼。",
    },
    ...
    # ════════════ 天氣 ════════════
    {
        ...
        "effects": {"satisfaction_delta": -2, "anxiety_delta": 4},
        "cooldown_days": 60,
        "prompt_hint": "最近熱到爆，冷氣電費帳單快讓人喘不過氣。",
    },
    {
        "id": "weather_cold_snap",
        "name": "寒流",
        "category": "weather",
        "description": "強烈寒流低溫破紀錄",
        "probability": 0.05,
        "eligibility": {},
        "effects": {"satisfaction_delta": -2, "anxiety_delta": 4},
        "cooldown_days": 60,
        "prompt_hint": "寒流讓人冷到不想出門，擔心家裡長輩身體。",
    },

    # ════════════ 社群／媒體壓力 ════════════
    {
        "id": "social_threads_political",
        "name": "被政論洗版",
        "category": "media",
        "description": "Threads/FB 被政治議題瘋狂洗版",
        "probability": 0.08,
        "eligibility": {"age_min": 20, "age_max": 55},
        "effects": {"satisfaction_delta": -2, "anxiety_delta": 5},
        "cooldown_days": 30,
        "prompt_hint": "滑 Threads 整條 feed 都在吵政治，看到整個心情被影響。",
    },
    {
        "id": "social_line_fake_news",
        "name": "長輩假訊息",
        "category": "media",
        "description": "長輩在 LINE 群組轉傳假新聞",
        "probability": 0.07,
        "eligibility": {"age_min": 30, "age_max": 60},
        "effects": {"satisfaction_delta": -3, "anxiety_delta": 4},
        "cooldown_days": 30,
        "prompt_hint": "爸媽又在 LINE 家族群組轉假訊息，跟他們解釋半天還是相信。",
    },
    ...
    # ════════════ 寵物 ════════════
    {
        ...
        "name": "毛小孩生病",
        "category": "pet",
        "description": "貓狗突然生病要看急診",
        "probability": 0.05,
        "eligibility": {"age_min": 22, "age_max": 65},
        "effects": {"satisfaction_delta": -5, "anxiety_delta": 8},
        "cooldown_days": 120,
        "prompt_hint": "毛小孩突然生病跑了一趟動物醫院，看著牠虛弱的樣子超心疼。",
    },

    # ════════════ 娛樂消費 ════════════
    {
        "id": "entertainment_concert_ticket",
        "name": "演唱會搶票",
        "category": "leisure",
        "description": "偶像演唱會搶票成功或失敗",
        "probability": 0.05,
        "eligibility": {"age_min": 18, "age_max": 40},
        "effects": {"satisfaction_delta": 3, "anxiety_delta": 0},
        "cooldown_days": 180,
        "prompt_hint": "今天守在電腦前搶演唱會門票，搶到（或沒搶到）整個心情起伏超大。",
    },
    {
        "id": "finance_stock_swing",
        "name": "股市波動",
        "category": "finance",
        "description": "台股/美股大漲大跌影響個人資產",
        "probability": 0.06,
        "eligibility": {"age_min": 25, "age_max": 75,
                        "occupation_exclude": _STUDENT},
        "effects": {"satisfaction_delta": -2, "anxiety_delta": 5},
        "cooldown_days": 45,
        "prompt_hint": "今天台股大跌（或大漲），看著自己的定期定額或存股心情上下起伏。",
    },
]
