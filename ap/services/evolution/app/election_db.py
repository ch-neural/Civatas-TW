...
# Soft-fail import: delegate every public function to election_db_us. If the
# legacy US backend has been removed, every call becomes a no-op that returns
# empty data (safer than module-load failure; downstream uses election_db as
...
try:
    ...
    logger.info("election_db_us backend unavailable; election_db returns empty")
