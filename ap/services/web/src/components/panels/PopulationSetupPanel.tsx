          ...
          <div style={{ display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
            ...
            <div style={{ flexShrink: 0 }}>
              {(() => {
                ...
                // TW: single-county scope uses scope === "county" (與 US 的 "state" 對應)
                const isCountyScope =
                ...
                const handleCountyClick = (countyName: string) => {
                  ...
                  const countyTpl = usTemplates.find(
                    (t) =>
                      (t.election?.scope === "county" || t.election?.scope === "state") &&
                      t.region_code === countyName
                  );
                  if (countyTpl) {
                    setUsTemplate(countyTpl.id);
                    setActiveTemplateId(wsId, countyTpl.id);
                  }
                };
                return (
                  <USMap
